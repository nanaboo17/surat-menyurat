...
import BackButtonAcc from "@/components/BackButtonAcc";
      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.section}>
          <View style={styles.line}>
            ...
            <Text>: {nomor_surat_acceptance}</Text>
          </View>
          <View style={styles.line}>
        ...
        <View style={styles.section}>
          <Text style={[styles.paragraph, { marginTop: 20 }]}>
            ...
            Kegiatan ini dihitung pada {start_date} s.d. {completion_date}{" "}
            periode Tahun Ajaran {tahun_ajaran}.
          </Text>
          <Text style={styles.paragraph}>
...
export default function ShowLetterPage() {
  ...
  console.log("Acceptance Letter Data:", {
    nomor_surat_acceptance: letterData.nomor_surat_acceptance || "-",
