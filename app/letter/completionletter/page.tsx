...
export default function CompletionLetterPage() {
  const [appliedCompletionLetters, setAppliedCompletionLetters] = useState<
  ...
  useEffect(() => {
    const fetchAppliedCompletionLetters = async () => {
      const response = await fetch("/api/appliedLetters"); // Replace with actual API
      const data = await response.json();
      setAppliedCompletionLetters(data);
    };

    fetchAppliedCompletionLetters();
  }, []);
        ...
        <div className="bg-white p-6 rounded-lg shadow-md mt-6">
          ...
          <div className="flex justify-between items-start mb-4">
            ...
            <div className="flex flex-col space-y-3">
              ...
              <div className="flex space-x-2">
                <button
                  onClick={() =>
                    router.push("/letter/completionletter/applyLetter")
                  }
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            <table className="w-full border border-black border-collapse">
              ...
              <tbody>
                {appliedCompletionLetters.length > 0 ? (
                  appliedCompletionLetters.map((letter, index) => (
